...
export function SpeedTestExperience({ lists, initialListId, initialDailyMode = false, fixedSource, progressById = {}, backHref = "/tu-cua-toi", backLabel = "Về bộ từ", challengeDate, dailyCompletedToday = false, dailyBestAccuracy, rankedMode = false, rankedAttemptsRemaining = 3 }: { lists: SpeedList[]; initialListId?: string; initialDailyMode?: boolean; fixedSource?: SpeedTestSource; progressById?: Record<string, SpeedTestWordProgress>; backHref?: string; backLabel?: string; challengeDate: string; dailyCompletedToday?: boolean; dailyBestAccuracy?: number; rankedMode?: boolean; rankedAttemptsRemaining?: number }) {
