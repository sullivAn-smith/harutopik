...
export function CardReactionExperience({ vocabulary, lessonName, lessonId, courseSlug, lessonSlug, progressById, backHref }: {
  ...
  if (stage === "countdown") return <main className="grid min-h-dvh place-items-center bg-[#111827] text-center text-white"><div><p className="font-black uppercase tracking-[.3em] text-fuchsia-300">Sẵn sàng dọn board?</p><b className="mt-5 block text-[9rem] leading-none">{countdown || "BẮT ĐẦU!"}</b></div></main>;
