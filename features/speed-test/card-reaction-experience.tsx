...
export function CardReactionExperience({ vocabulary, lessonName, lessonId, courseSlug, lessonSlug, progressById, backHref, rankedMode = false, rankedAttemptsRemaining = 3 }: {
  vocabulary: VocabularyItem[]; lessonName: string; lessonId: string; courseSlug: string; lessonSlug: string;
  progressById: Record<string, SpeedTestWordProgress>; backHref: string; rankedMode?: boolean; rankedAttemptsRemaining?: number;
}) {
