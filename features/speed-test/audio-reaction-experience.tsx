...
function ResultScreen({ lessonName, answered, total, score, elapsedMs, lives, bestCombo, answers, savedResult, syncState, historyHref, onRetry, onBackToArena }: {
  lessonName: string; answered: number; total: number; score: number; elapsedMs: number; lives: number; bestCombo: number; answers: LocalAnswer[]; savedResult: SavedResult | null; syncState: "idle" | "saving" | "saved" | "failed"; historyHref: string; onRetry: () => void; onBackToArena?: () => void;
}) {
