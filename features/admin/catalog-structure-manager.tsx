...
export function CatalogStructureManager({
  entries,
  query,
  returnTo,
}: {
  entries: CatalogStructureOption[];
  query: { created?: string; error?: string };
  returnTo: "/bien-tap/cau-truc" | "/quan-tri/cau-truc";
}) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
      ...
      <p className="mt-3 max-w-3xl leading-7 text-ink-600">
        Content editor có thể chủ động tạo khung khóa học và chương trước khi
        soạn bài. ID ổn định không nên thay đổi sau khi đã sử dụng.
      </p>
      {query.created && (
