  ...
  return (
    <main className="elegant-blue min-h-screen text-[#10243e]">
      <div className="mx-auto max-w-6xl px-5 py-10">
        <div className="flex flex-wrap items-center justify-between gap-4"><div><Link href="/" className="font-black text-[#087eba]">← Trang chủ</Link><h1 className="mt-3 text-4xl font-black md:text-5xl">Lịch sử luyện đề</h1><p className="mt-2 font-semibold text-slate-600">Mỗi đề được gom gọn theo toàn bộ các lần bạn đã làm.</p></div><ExamLibraryTabs active="history" /></div>
